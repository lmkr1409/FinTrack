...
class MerchantRuleDialog extends ConsumerStatefulWidget {
  final MerchantRule? rule;
  final VoidCallback onSaved;

  const MerchantRuleDialog({super.key, this.rule, required this.onSaved});

  @override
  ConsumerState<MerchantRuleDialog> createState() => _MerchantRuleDialogState();
}

class _MerchantRuleDialogState extends ConsumerState<MerchantRuleDialog> {
  ...
  Future<void> _save() async {
    ...
    final repo = ref.read(merchantRuleRepositoryProvider);
    if (widget.rule == null) {
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    widget.rule == null ? 'New Merchant Rule' : 'Edit Merchant Rule',
              ...
              child: ListView(
                ...
                children: [
                  ...
                  FilledButton.icon(
                    ...
                    label: Text(_saving ? 'Saving…' : 'Save Merchant Rule'),
