...
INSERT INTO sub_category (subcategory_name, icon, icon_color, priority, category_id) VALUES ('LumpSum', 'payments', '#3949AB', 2, (SELECT category_id FROM category WHERE category_name = 'Mutual Funds'));
